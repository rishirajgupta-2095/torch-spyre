    ...
    def write_header(self) -> None:
        ...
        self.imports.splice(
            """
                ...
                from torch_spyre._inductor.op_spec import TensorArg, OpSpec, UnimplementedOp, LoopSpec, spyre_constant_tensor, IndexLoad
                from torch_spyre.execution.async_compile import SpyreAsyncCompile
                from torch_spyre._C import DataFormats, ElementArrangement, SpyreTensorLayout, spyre_empty_with_layout
                import subprocess
            """,
            strip=True,
        )
