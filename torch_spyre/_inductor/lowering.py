...
def lower_scaled_bmm(
    ...
    if mat1_ndim == 3 and mat2_ndim == 3:
        ...
        # Each loader index is one clean iteration symbol, mirroring lower_bmm's
        # 4D branch. Recovering b and h from a fused i_bh via // and % would make
        # the same symbol appear in two device_coordinates, which garbles the
        # dim-order scan in _get_device_dim_order.
    ...
    # through to codegen so B=1 batch dims get the correct SDSC layout.
